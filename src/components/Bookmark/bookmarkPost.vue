<template>
  <div>
    ...
    <vs-row>
      <vs-col v-for="post in watchListMoviesList" :key="post.imdbID" w="12">
        <div id="B-bright" class="B-movie_card">
          <div class="B-info_section">
            ...
            <div class="B-movie_header">
              ...
              <h1>{{ post.Title }}</h1>
              <span class="B-minutes">{{ post.Runtime }}</span>
              ...
              <p style="display: inline-block; position: relative; bottom: 10px; left:7px; color: rgba(0, 0, 0, 0.7);">
                {{ post.imdbRating }} / 10 ({{post.imdbVotes}})</p>
            </div>
            <!-- -----------------        ///      --------------------- -->
            ...
            <div class="B-movie_social">
              <ul>
                <li>
                  <div @click="activeDownload = true; selectedMovie=post.Title; selectedMovieID=post.imdbID; selectedMovieRate=post.imdbRating">
                  <i class="iconify borderIC" data-icon="bx:bxs-download" style="font-size:30px; color:#2f2f2f"></i>
                  </div>
                </li>
                <li>
                  <div @click="del(post.imdbID)">
